...
<div id ="content_area">
  <div class="create_item"> 
    <button><a href="create_coffee.php">Create item</a></button>
</div>
<input class="searcher" style="height:50px" type="text" id="myInput" onkeyup="myFunction()" name="" placeholder="Search...">
      ...
      $query = mysqli_query($con,"SELECT * FROM coffees");
      while($items = mysqli_fetch_assoc($query)){ ?>
        <li>
          <div class="card">
      <a href="Espresso.php" class="title"> <?php echo $items['name']; ?>  </a>    
        <img src=<?php echo $items['srcOfImage'];?> >
      <div class="price">

        <?php echo $items['price'];?> <span>KZT</span>
      </div>
          </div>
      </li>
      <?php } ?> 
